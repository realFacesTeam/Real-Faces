...
Skin.prototype.UVMap = function(mesh, face, x, y, w, h, rotateBy) {
  ...
  // console.log('uvs0')
  // console.log(uvs[ (0 + rotateBy) % 4 ])
  // console.log('uvs3')
  // console.log(uvs[ (3 + rotateBy) % 4 ])
...
Skin.prototype.createPlayerObject = function(scene) {
  ...
  // var helmet = this.cubeFromPlanes(9, plainMaterial);
  // helmet.position.y = 2;
  ...
  // var leftear = new THREE.Mesh(eargeo, plainMaterial);
  // var rightear = new THREE.Mesh(eargeo, plainMaterial);
